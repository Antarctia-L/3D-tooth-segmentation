...
from model import PointNet, DC_Net
import numpy as np
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model', type=str, default='DC_Net', metavar='N',
                        choices=['pointnet', 'DC_Net'],
                        help='Model to use, [pointnet, DC_Net]')
