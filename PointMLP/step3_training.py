...
previous_check_point_name = 'Mesh_Segementation_520samples_1.0_best.tar'
...
# train_list='./main/data_new_150lower+150upper_b1.h5'
train_list='./main/data_new_270lower+270upper_b1_10k.h5'
val_list='./main/data_new_20lower+20upper_b1_10k.h5'

model_path = './models/'
model_name = 'Mesh_Segementation_520samples_1.1' # need to define
...
model = pointMLP_seg(num_classes=num_classes)
# model = DC_Net()
...
for epoch in range(num_epochs):
    ...
    for i_batch, batched_sample in enumerate(train_loader):
        ...
        one_hot_labels = labels.transpose(1, 2) 
